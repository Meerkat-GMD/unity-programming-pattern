...
public sealed class Lesson15EventQueueDemo : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        GUI.Label(new Rect(36, 30, Screen.width - 72, 70), "15차시 EventQueue Pattern", titleStyle);
