...
public sealed class Lesson08DoubleBufferDemo : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        GUI.Label(new Rect(36, 30, Screen.width - 72, 70), "8차시 DoubleBuffer Pattern", titleStyle);
