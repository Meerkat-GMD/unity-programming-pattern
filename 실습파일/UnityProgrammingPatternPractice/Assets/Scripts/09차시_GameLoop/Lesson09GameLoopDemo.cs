...
public sealed class Lesson09GameLoopDemo : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        GUI.Label(new Rect(36, 30, Screen.width - 72, 70), "9차시 GameLoop Pattern", titleStyle);
