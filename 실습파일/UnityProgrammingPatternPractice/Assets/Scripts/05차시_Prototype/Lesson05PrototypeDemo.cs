...
public sealed class Lesson05PrototypeDemo : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        GUI.Label(new Rect(36, 30, Screen.width - 72, 70), "5차시 Prototype Pattern", titleStyle);
