...
public sealed class Lesson17DataLocalityDemo : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        GUI.Label(new Rect(36, 30, Screen.width - 72, 70), "17차시 DataLocality Pattern", titleStyle);
