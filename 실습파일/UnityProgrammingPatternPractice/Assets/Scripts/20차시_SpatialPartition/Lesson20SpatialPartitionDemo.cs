...
public sealed class Lesson20SpatialPartitionDemo : MonoBehaviour
{
    ...
    private void Start()
    {
        log.Add("20차시 SpatialPartition 실습");
    ...
    private void OnGUI()
    {
        ...
        GUI.Label(new Rect(36, 30, Screen.width - 72, 70), "20차시 SpatialPartition Pattern", titleStyle);
