...
public sealed class Lesson11BytecodeDemo : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        GUI.Label(new Rect(36, 30, Screen.width - 72, 70), "11차시 Bytecode Pattern", titleStyle);
