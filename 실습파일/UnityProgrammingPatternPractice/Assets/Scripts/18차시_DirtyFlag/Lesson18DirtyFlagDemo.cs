...
public sealed class Lesson18DirtyFlagDemo : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        GUI.Label(new Rect(36, 30, Screen.width - 72, 70), "18차시 DirtyFlag Pattern", titleStyle);
