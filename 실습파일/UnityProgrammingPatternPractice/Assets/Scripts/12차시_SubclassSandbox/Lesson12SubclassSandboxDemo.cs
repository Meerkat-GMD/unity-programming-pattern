...
public sealed class Lesson12SubclassSandboxDemo : MonoBehaviour
{
    ...
    private void Start()
    {
        log.Add("12차시 SubclassSandbox 실습");
    ...
    {
        // TODO 1: 기본 Activate 정의
        // TODO 2: protected helper 사용
        // TODO 3: 하위 클래스 구현
        // TODO 4: 중복 제거
        // TODO 5: HUD 로그
    ...
    private void OnGUI()
    {
        ...
        GUI.Label(new Rect(36, 30, Screen.width - 72, 70), "12차시 SubclassSandbox Pattern", titleStyle);
