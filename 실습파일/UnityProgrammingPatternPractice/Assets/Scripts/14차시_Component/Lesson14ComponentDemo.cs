...
public sealed class Lesson14ComponentDemo : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        GUI.Label(new Rect(36, 30, Screen.width - 72, 70), "14차시 Component Pattern", titleStyle);
