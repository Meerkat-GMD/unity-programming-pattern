...
public sealed class Lesson10UpdateMethodDemo : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        GUI.Label(new Rect(36, 30, Screen.width - 72, 70), "10차시 UpdateMethod Pattern", titleStyle);
